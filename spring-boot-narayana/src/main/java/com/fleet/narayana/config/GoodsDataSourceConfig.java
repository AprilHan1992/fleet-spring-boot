package com.fleet.narayana.config;
 ...
 */
@Configuration
@MapperScan(basePackages = "com.fleet.narayana.dao.goods", sqlSessionFactoryRef = "goodsSqlSessionFactory", sqlSessionTemplateRef = "goodsSqlSessionTemplate")
public class GoodsDataSourceConfig {
    ...
    public DataSource goods(@Qualifier("goodsDataSourceProperties") DataSourceProperties goodsDataSourceProperties) throws Exception {
        ...
        return new NarayanaDataSourceBean(mysqlXADataSource);
    }
